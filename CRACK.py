...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://www.facebook.com/profile.php?id=100087746153557&mibextid=ZbWKwL')
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)        
        print(" [01] Shorif fb account       \033[1;34m")
        print(" [02] Shorif insta account     \033[1;35m")
        print(" [00] Exit")        
        Alif =input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/profile.php?id=100087746153557&mibextid=ZbWKwL')
        if Alif in ["1", "01"]:
...
def num():
    ...
    kode = input(' [?] Enter Shorif address: ')
